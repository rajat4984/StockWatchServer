...
exports.searchStock = exports.getStockInfo = void 0;
const yahoo_finance2_1 = __importDefault(require("yahoo-finance2"));
const getStockInfo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { stockSymbol } = req.params;
    try {
        console.log(stockSymbol);
        const results = yield yahoo_finance2_1.default.search(stockSymbol);
...
const searchStock = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { stockSymbol } = req.params;
    try {
        const result = yield yahoo_finance2_1.default.search(stockSymbol);
